...
const game_def_t def = {
	...
	.pilots = {
		{.name = "JOHN DEKKA",           .portrait = "wipeout/textures/dekka.cmp", .logo_model = 0, .team = 0 },
		{.name = "DANIEL CHANG",         .portrait = "wipeout/textures/chang.cmp", .logo_model = 4, .team = 0 },
		{.name = "ARIAL TETSUO",         .portrait = "wipeout/textures/arial.cmp", .logo_model = 6, .team = 1 },
		{.name = "ANASTASIA CHEROVOSKI", .portrait = "wipeout/textures/anast.cmp", .logo_model = 7, .team = 1 },
		{.name = "KEL SOLAAR",           .portrait = "wipeout/textures/solar.cmp", .logo_model = 2, .team = 2 },
		{.name = "ARIAN TETSUO",         .portrait = "wipeout/textures/arian.cmp", .logo_model = 5, .team = 2 },
		{.name = "SOFIA DE LA RENTE",    .portrait = "wipeout/textures/sophi.cmp", .logo_model = 1, .team = 3 },
		{.name = "PAUL JACKSON",         .portrait = "wipeout/textures/paul.cmp",  .logo_model = 3, .team = 3 },
	},
	...
	.teams = {
		{
			...
			.pilots = {0, 1},
			.attributes = {
				{.mass = 150, .thrust_max =  790, .resistance = 140, .turn_rate = TURN_ACCEL(160), .turn_rate_max = TURN_VEL(2560), .skid = 12},
				{.mass = 150, .thrust_max = 1200, .resistance = 140, .turn_rate = TURN_ACCEL(160), .turn_rate_max = TURN_VEL(2560), .skid = 10},
			},
		},
		{
			.name = "AURICOM",
			...
			.pilots = {2, 3},
			.attributes = {
				{.mass = 150, .thrust_max =  850, .resistance = 134, .turn_rate = TURN_ACCEL(140), .turn_rate_max = TURN_VEL(1920), .skid = 20},
				{.mass = 150, .thrust_max = 1400, .resistance = 140, .turn_rate = TURN_ACCEL(120), .turn_rate_max = TURN_VEL(1920), .skid = 14},
			},
		},
		{
			.name = "QIREX",
			...
			.pilots = {4, 5},
			.attributes = {
				{.mass = 150, .thrust_max =  850, .resistance = 140, .turn_rate = TURN_ACCEL(120), .turn_rate_max = TURN_VEL(1920), .skid = 24},
				{.mass = 150, .thrust_max = 1400, .resistance = 130, .turn_rate = TURN_ACCEL(140), .turn_rate_max = TURN_VEL(1920), .skid = 16},
			},
		},
		{
			.name = "FEISAR",
			...
			.pilots = {6, 7},
			.attributes = {
				{.mass = 150, .thrust_max =  790, .resistance = 134, .turn_rate = TURN_ACCEL(180), .turn_rate_max = TURN_VEL(2560), .skid = 12},
				{.mass = 150, .thrust_max = 1200, .resistance = 130, .turn_rate = TURN_ACCEL(180), .turn_rate_max = TURN_VEL(2560), .skid =  8},
			},
		},
	},
	...
	.circuts = {
		{
			...
			.settings = {
				{.path = "wipeout/track02/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = -2520},
				{.path = "wipeout/track03/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = -1930},
			}
		},
		{
			.name = "KARBONIS V",
			.is_bonus_circut = false,
			.settings = {
				{.path = "wipeout/track04/", .start_line_pos = 16, .behind_speed = 200, .spread_base = 10, .spread_factor =  8, .sky_y_offset = -5000},
				{.path = "wipeout/track05/", .start_line_pos = 16, .behind_speed = 500, .spread_base = 10, .spread_factor =  8, .sky_y_offset = -5000},
			}
		},
		{
			.name = "TERRAMAX",
			.is_bonus_circut = false,
			.settings = {
				{.path = "wipeout/track01/", .start_line_pos = 27, .behind_speed = 350, .spread_base = 60, .spread_factor = 11, .sky_y_offset =  -820},
				{.path = "wipeout/track06/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 10, .spread_factor =  8, .sky_y_offset =     0},
			}
		},
		{
			.name = "KORODERA",
			.is_bonus_circut = false,
			.settings = {
				{.path = "wipeout/track12/", .start_line_pos = 16, .behind_speed = 450, .spread_base = 40, .spread_factor = 11, .sky_y_offset = -2120},
				{.path = "wipeout/track07/", .start_line_pos = 16, .behind_speed = 500, .spread_base = 30, .spread_factor = 11, .sky_y_offset = -2260},
			}
		},
		{
			.name = "ARRIDOS IV",
			.is_bonus_circut = false,
			.settings = {
				{.path = "wipeout/track08/", .start_line_pos = 16, .behind_speed = 350, .spread_base = 80, .spread_factor = 15, .sky_y_offset =   -40},
				{.path = "wipeout/track11/", .start_line_pos = 16, .behind_speed = 450, .spread_base = 30, .spread_factor = 11, .sky_y_offset =  -240},
			}
		},
		{
			.name = "SILVERSTREAM",
			.is_bonus_circut = false,
			.settings = {
				{.path = "wipeout/track09/", .start_line_pos = 16, .behind_speed = 150, .spread_base = 10, .spread_factor =  8, .sky_y_offset = -2700},
				{.path = "wipeout/track13/", .start_line_pos = 16, .behind_speed = 150, .spread_base = 10, .spread_factor =  8, .sky_y_offset = -2700},
			}
		},
		{
			.name = "FIRESTAR",
			...
			.settings = {
				{.path = "wipeout/track10/", .start_line_pos = 27, .behind_speed = 200, .spread_base = 40, .spread_factor = 11, .sky_y_offset =     0},
				{.path = "wipeout/track14/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 40, .spread_factor = 11, .sky_y_offset =     0},
			}
		},
	},
...
save_t save = {
	...
	.buttons = {
		{INPUT_KEY_UP, INPUT_GAMEPAD_DPAD_UP},
		{INPUT_KEY_DOWN, INPUT_GAMEPAD_DPAD_DOWN},
		{INPUT_KEY_LEFT, INPUT_GAMEPAD_DPAD_LEFT},
		{INPUT_KEY_RIGHT, INPUT_GAMEPAD_DPAD_RIGHT},
		{INPUT_KEY_C, INPUT_GAMEPAD_L_SHOULDER},
		{INPUT_KEY_V, INPUT_GAMEPAD_R_SHOULDER},
		{INPUT_KEY_X, INPUT_GAMEPAD_A},
		{INPUT_KEY_Z, INPUT_GAMEPAD_X},
		{INPUT_KEY_A, INPUT_GAMEPAD_Y},
	},
	...
	.highscores = {
		{
			{
				{.entries = {{"WIP", 254.50},{"EOU", 271.17},{"TPC", 289.50},{"NOT", 294.50},{"PSX", 314.50}}, .lap_record = 85.83},
				{.entries = {{"MVE", 254.50},{"ALM", 271.17},{"POL", 289.50},{"NIK", 294.50},{"DAR", 314.50}}, .lap_record = 85.83},
			},
			{
				{.entries = {{"AJY", 159.33},{"AJS", 172.67},{"DLS", 191.00},{"MAK", 207.67},{"JED", 219.33}}, .lap_record = 55.33},
				{.entries = {{"DAR", 159.33},{"STU", 172.67},{"MOC", 191.00},{"DOM", 207.67},{"NIK", 219.33}}, .lap_record = 55.33},
			},
			{
				{.entries = {{ "JD", 171.00},{"AJC", 189.33},{"MSA", 202.67},{ "SD", 219.33},{"TIM", 232.67}}, .lap_record = 57.5},
				{.entries = {{"PHO", 171.00},{"ENI", 189.33},{ "XR", 202.67},{"ISI", 219.33},{ "NG", 232.67}}, .lap_record = 57.5},
			},
			{
				{.entries = {{"POL", 251.33},{"DAR", 263.00},{"JAS", 283.00},{"ROB", 294.67},{"DJR", 314.82}}, .lap_record = 85.17},
				{.entries = {{"DOM", 251.33},{"DJR", 263.00},{"MPI", 283.00},{"GOC", 294.67},{"SUE", 314.82}}, .lap_record = 85.17},
			},
			{
				{.entries = {{"NIK", 236.17},{"SAL", 253.17},{"DOM", 262.33},{ "LG", 282.67},{"LNK", 298.17}}, .lap_record = 80.17},
				{.entries = {{"NIK", 236.17},{"ROB", 253.17},{ "AM", 262.33},{"JAS", 282.67},{"DAR", 298.17}}, .lap_record = 80.17},
			},
			{
				{.entries = {{"HAN", 182.33},{"PER", 196.33},{"FEC", 214.83},{"TPI", 228.83},{"ZZA", 244.33}}, .lap_record = 61.67},
				{.entries = {{ "FC", 182.33},{"SUE", 196.33},{"ROB", 214.83},{"JEN", 228.83},{ "NT", 244.33}}, .lap_record = 61.67},
			},
			{
				{.entries = {{"CAN", 195.40},{"WEH", 209.23},{"AVE", 227.90},{"ABO", 239.90},{"NUS", 240.73}}, .lap_record = 63.83},
				{.entries = {{"DJR", 195.40},{"NIK", 209.23},{"JAS", 227.90},{"NCW", 239.90},{"LOU", 240.73}}, .lap_record = 63.83},
			},
		},
		{
			{
				{.entries = {{"AJY", 200.67},{"DLS", 213.50},{"AJS", 228.67},{"MAK", 247.67},{"JED", 263.00}}, .lap_record = 69.50},
				{.entries = {{"NCW", 200.67},{"LEE", 213.50},{"STU", 228.67},{"JAS", 247.67},{"ROB", 263.00}}, .lap_record = 69.50},
			},
			{
				{.entries = {{"BOR", 134.58},{"ING", 147.00},{"HIS", 162.25},{"COR", 183.08},{ "ES", 198.25}}, .lap_record = 47.33},
				{.entries = {{"NIK", 134.58},{"POL", 147.00},{"DAR", 162.25},{"STU", 183.08},{"ROB", 198.25}}, .lap_record = 47.33},
			},
			{
				{.entries = {{"AJS", 142.08},{"DLS", 159.42},{"MAK", 178.08},{"JED", 190.25},{"AJY", 206.58}}, .lap_record = 47.83},
				{.entries = {{"POL", 142.08},{"JIM", 159.42},{"TIM", 178.08},{"MOC", 190.25},{ "PC", 206.58}}, .lap_record = 47.83},
			},
			{
				{.entries = {{"DLS", 224.17},{"DJR", 237.00},{"LEE", 257.50},{"MOC", 272.83},{"MPI", 285.17}}, .lap_record = 76.75},
				{.entries = {{"TIM", 224.17},{"JIM", 237.00},{"NIK", 257.50},{"JAS", 272.83},{ "LG", 285.17}}, .lap_record = 76.75},
			},
			{
				{.entries = {{"MAK", 191.00},{"STU", 203.67},{"JAS", 221.83},{"ROB", 239.00},{"DOM", 254.50}}, .lap_record = 65.75},
				{.entries = {{ "LG", 191.00},{"LOU", 203.67},{"JIM", 221.83},{"HAN", 239.00},{ "NT", 254.50}}, .lap_record = 65.75},
			},
			{
				{.entries = {{"JED", 156.67},{"NCW", 170.33},{"LOU", 188.83},{"DAR", 201.00},{"POL", 221.50}}, .lap_record = 59.23},
				{.entries = {{"STU", 156.67},{"DAV", 170.33},{"DOM", 188.83},{"MOR", 201.00},{"GAN", 221.50}}, .lap_record = 59.23},
			},
			{
				{.entries = {{ "PC", 162.42},{"POL", 179.58},{"DAR", 194.75},{"DAR", 208.92},{"MSC", 224.58}}, .lap_record = 55.00},
				{.entries = {{"THA", 162.42},{"NKS", 179.58},{"FOR", 194.75},{"PLA", 208.92},{"YIN", 224.58}}, .lap_record = 55.00},
			}
		}
	}
};
...
struct {
	...
	{intro_init, intro_update},
	{title_init, title_update},
	{main_menu_init, main_menu_update},
	{race_init, race_update},
};
...
void game_init(void) {
	try
	{
		auto vector = platform_load_userdata("save.dat");
		save_t *save_file = (save_t *)vector.data();
	...
	{
		std::cerr << "No save data found, continuing without" << std::endl;
	}

	platform_set_fullscreen(save.fullscreen);
	render_set_resolution((render_resolution_t)save.screen_res);
	render_set_post_effect((render_post_effect_t)save.post_effect);
	...
	for (int action = 0; action < len(save.buttons); action++) {
		if (save.buttons[action][0] != INPUT_INVALID) {
			input_bind(INPUT_LAYER_USER, (button_t)save.buttons[action][0], action);
		}
		if (save.buttons[action][1] != INPUT_INVALID) {
			input_bind(INPUT_LAYER_USER, (button_t)save.buttons[action][1], action);
		}
	}
